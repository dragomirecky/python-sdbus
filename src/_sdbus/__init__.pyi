...
class _SdBus:
    ...
    def emit_interfaces_added(self, path: str, *interfaces: str) -> None: ...
    def emit_interfaces_removed(self, path: str, *interfaces: str) -> None: ...
    def emit_properties_changed(self, path: str, interface: str, *properties: str) -> None: ...
    def close(self) -> None: ...
    def start(self) -> None: ...
